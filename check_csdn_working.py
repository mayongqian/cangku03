...
def run():
    ...
    try:
        ...
        if page.status_code == 200 and page.content.decode("utf-8").find('<title>CSDN-专业的IT技术社区</title>') >= 0:
        ...
        yag.send(to = ['2802370278@qq.com'], subject = '服务异常', contents = ['The home page is tampered with, please handle it in time'])
        sys.exit(-1)
